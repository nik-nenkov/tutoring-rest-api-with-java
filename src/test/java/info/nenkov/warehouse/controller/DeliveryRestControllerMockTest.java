...
public class DeliveryRestControllerMockTest {
  ...
  private final JacksonTester<Delivery> jsonDelivery = null;
  private MockMvc mvc;
  @Mock private DeliveryRepository deliveryRepository;
  @Mock private StockRepository stockRepository;
  @InjectMocks private DeliveryService deliveryService;
  @InjectMocks private DeliveryRestController deliveryRestController;
  ...
  public void setup() {
    ...
    mvc = MockMvcBuilders.standaloneSetup(deliveryRestController).build();
  }
  ...
  public void addNewDeliveryScheduled() throws Exception {
    Delivery testDelivery1 =
        new Delivery(
            22, 345, 200, new Timestamp(sdf.parse("2018-10-03 17:45:00").getTime()), true, 5L);
    // given
