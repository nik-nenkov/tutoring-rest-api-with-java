...
public class OrderRestControllerTest extends BasicRepositoryTest {
    ...
    public void getOrderById() {
        assertThat(this
                ...
                .getForObject("http://localhost:" + port + "/order?id=8",
                        String.class)
        ).isEqualTo("{\"orderId\":8,\"quantity\":20,\"price\":10.05,\"stock_id\":442,\"order_timestamp\":\"2018-07-19T11:00:00.000+0000\"}");
    }
}