...
public class OrderRepositoryIntegrationTest implements RepositoryIntegrationTest {
  ...
  public void addSomeEntries() {
    jdbcTemplate.execute(
        "INSERT INTO `test_warehouse_db`.`stock` (`stock_id`, `quantity`, `price`) VALUES ('442', '40', '3.4');");
    jdbcTemplate.execute(
        "INSERT INTO `test_warehouse_db`.`stock` (`stock_id`, `quantity`, `price`) VALUES ('3232', '50', '7.8');");
  ...
  public void getOrdersAfterSpecificTimestamp() throws ParseException {
    ...
    jdbcTemplate.execute(
        "INSERT INTO `test_warehouse_db`.`stock` (`stock_id`, `quantity`, `price`) VALUES ('3232', '50', '7.8');");
    jdbcTemplate.execute(
        "insert into `test_warehouse_db`.`order` "
