...
import info.nenkov.warehouse.service.RevisionService;
...
public class RevisionRestController {
  ...
  public Revision reviseLastThirtyMinutes(
    ...
    java.sql.Timestamp startingTime =
        new java.sql.Timestamp(System.currentTimeMillis() - milliseconds);
    return revisionService.sumOfRevisionsFromTimestamp(startingTime);
  }

  @GetMapping("/interval")
  public Revision makeRevisionByGivenTimeInterval(
      @RequestParam("from") String startDate, @RequestParam("to") String endDate)
