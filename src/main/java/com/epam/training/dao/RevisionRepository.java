...
public class RevisionRepository extends NamedParameterJdbcDaoSupport {
  ...
  public Revision getLastRevisionEntered() {
    ...
    return Objects.requireNonNull(getNamedParameterJdbcTemplate())
        .queryForObject(SELECT_REVISION_LAST_ENTERED, params, new RevisionRowMapper());
  }
  ...
  public List<Revision> getRevisionsInTimeInterval(Timestamp startingTime, Timestamp endingTime) {
    ...
    return Objects.requireNonNull(getNamedParameterJdbcTemplate())
        .query(SELECT_REVISIONS_FROM_TIMESTAMP, params, new RevisionRowMapper());
  }

  public void insertNewRevision(
      Integer sumQuantity, BigDecimal sumOfPrice, Timestamp startingTime, Timestamp endingTime) {
    Map<String, Object> params = new HashMap<>();
